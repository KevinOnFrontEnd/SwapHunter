...
***A dev fee of 0.03% is added onto the offer that is posted TibetSwap (Same as what the website does). The fee is split evening between the TibetSwap dev wallet & SwapHunter dev wallet.**
# Build & Test Status
